...
$(".select_qna input[type='checkbox'] ").click(function(e) {
    if($(this).prop("checked") == true){
        $(".user-qna").prop('checked', true);
    }
    else if($(this).prop("checked") == false){
        $(".user-qna").prop('checked', false);
    }
});
$(".select_other_qna input[type='checkbox'] ").click(function(e) {
    if($(this).prop("checked") == true){
        $(".other-user-qna").prop('checked', true);
    }
    else if($(this).prop("checked") == false){
        $(".other-user-qna").prop('checked', false);
    }
});
