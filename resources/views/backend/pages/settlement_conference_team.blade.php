            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Settlement Conference Team Page Settings</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.store-settlement-conference-team-page-settings',[@$main_page->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <select class="form-control form-control-select2" id="page_name" data-fouc name="page">
                                    @if(count($pages) > 0)
                                        @foreach($pages as $key => $page)
                                            @if($key == 'settlement-conference-team')
                            ...
                            <div class="form-group">
                                <label>Title:</label>
                                <input type="text" name="title" class="form-control" placeholder="Enter settlement conference team page title" value="{{ old('title', @$main_page->title) }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="section1_heading" class="form-control" placeholder="Enter home page section1 heading" value="{{ old('section1_heading', @$settlement_conference_team->section1_heading) }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Section1 Sub Heading:</label>
                                        <input type="text" name="section1_sub_heading" class="form-control" placeholder="Enter home page section1 sub heading" value="{{ old('section1_sub_heading', @$settlement_conference_team->section1_sub_heading) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Section1:</label>
                                <textarea rows="5" name="section_1" class="form-control" id="section_1">{{ old('section1', @$settlement_conference_team->section1) }}</textarea>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Section2 Heading:</label>
                                        <input type="text" name="section2_heading" class="form-control" placeholder="Enter home page section2 heading" value="{{ old('section2_heading', @$settlement_conference_team->section2_heading) }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Section2 Sub Heading:</label>
                                        <input type="text" name="section2_sub_heading" class="form-control" placeholder="Enter home page section2 sub heading" value="{{ old('section2_sub_heading', @$settlement_conference_team->section2_sub_heading) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Section2:</label>
                                <textarea rows="5" name="section_2" class="form-control" id="section_2">{{ old('section2', @$settlement_conference_team->section2) }}</textarea>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-10">
                                    ...
                                    <div class="col-md-2">
                                        @if(@$settlement_conference_team->section2_image != null)
                                            <img src="{{ asset('public/backend/images/cms_pages/'.@$settlement_conference_team->section2_image) }}" alt="section2_image" id="section2_image" class="img-fluid">
                                        @else
